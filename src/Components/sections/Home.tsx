  ...
  return (
    ...
    >
      <div className="text-center">
        <h1 data-aos="flip-right" className="md:text-5xl text-2xl font-bold font-Outfit mb-4 bg-gradient-to-bl from-amber-400 to-gray-200 bg-clip-text text-transparent">
          Welcome! I'm IrfanKhan
        </h1>
        <h1 data-aos="flip-right" className="md:text-2xl text-md font-bold font-Outfit mb-4 bg-gradient-to-tl from-amber-400 to-gray-200 bg-clip-text text-transparent">
          a {"<"}Web developer{"/>"}
        </h1>

        <p data-aos="flip-left" className=" text-gray-300  font-Outfit md:text-xl text-center text-sm tracking-[3px]  mb-0 md:max-w-lg max-w-[80%] mx-auto">
